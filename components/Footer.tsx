const Footer = () => {
  ...
  Empower Your AI Journey
          ...
          <a
            href="/auth"
            className="mt-8 inline-block rounded-full border border-purple-600 px-12 py-3 text-sm font-medium text-purple-600 hover:bg-purple-400 hover:text-white focus:outline-none focus:ring active:bg-indigo-500"
          >
            Get Started
          </a>
        </div>
